...
import { User, TrendingUp, Heart, BarChart3, PlusCircle, Settings, ExternalLink, X } from 'lucide-react';
...
const AdminUserPanel = ({ isOpen, onClose }: AdminUserPanelProps) => {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div className="fixed top-0 right-0 z-50 w-96 h-full bg-white shadow-xl overflow-y-auto">
