/*
  ...
  2. Security
    ...
    - No RLS on temp tables as they're managed by functions
...
-- Create policy for admins to manage bulk uploads
...
-- Enable RLS on temp_poll_uploads
ALTER TABLE public.temp_poll_uploads ENABLE ROW LEVEL SECURITY;
